...
export default function SupplierPage() {
  ...
  const handleViewLedger = useCallback(
    (row) => navigate(`/ledger/supplier/${row._id || row.id}`),
    [navigate],
  );
      ...
      actions={
        <div className={styles.headerBar}>
          ...
          {/* <button
            ...
            onClick={() =>
              navigate("/masters/supplier/add", {
                state: { defaultTab: recordType },
              })
            }
          >
          ...
          <div className={styles.statsBodyLeft}>
            <div className={styles.statBlock}>
              ...
              <span className={styles.statValue} data-color="red">
                {eyeOpen ? `₹${outstanding.toLocaleString("en-IN")}` : "_ _ _ _"}
              </span>
            </div>
            <div className={styles.statBlock}>
              ...
              <span className={styles.statValue} data-color="blue">
                {eyeOpen ? `₹${totalSales.toLocaleString("en-IN")}` : "_ _ _ _"}
              </span>
            </div>
          </div>
